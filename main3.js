...
function rel(){
    ...
    var area = parseFloat(document.getElementById("text7").value)//volume in graduated cylinder provided by user

    var cpa1 = parseFloat(c1/area)//Number per m2 area
    var cpa2 = parseFloat(c2/area)
    var cpa3 = parseFloat(c3/area)
    var cpa4 = parseFloat(c4/area)
    var cpa5 = parseFloat(c5/area)
    var cpa6 = parseFloat(c6/area)
    var cpa7 = parseFloat(c7/area)
    var cpa8 = parseFloat(c8/area)
    var cpa9 = parseFloat(c9/area)
    var cpa10 = parseFloat(c10/area)
    var cpa11 = parseFloat(c11/area)
    var cpa12 = parseFloat(c12/area)
    var cpa13 = parseFloat(c13/area)
    var cpa14 = parseFloat(c14/area)
    var cpa15 = parseFloat(c15/area)
    var cpa16 = parseFloat(c16/area)

    tbl1c.innerHTML = parseFloat(cpa1.toFixed(3))//insert cells per liter lake water in column "c" of table
    tbl2c.innerHTML = parseFloat(cpa2.toFixed(3))
    tbl3c.innerHTML = parseFloat(cpa3.toFixed(3))
    tbl4c.innerHTML = parseFloat(cpa4.toFixed(3))
    tbl5c.innerHTML = parseFloat(cpa5.toFixed(3))
    tbl6c.innerHTML = parseFloat(cpa6.toFixed(3))
    tbl7c.innerHTML = parseFloat(cpa7.toFixed(3))
    tbl8c.innerHTML = parseFloat(cpa8.toFixed(3))
    tbl9c.innerHTML = parseFloat(cpa9.toFixed(3))
    tbl10c.innerHTML = parseFloat(cpa10.toFixed(3))
    tbl11c.innerHTML = parseFloat(cpa11.toFixed(3))
    tbl12c.innerHTML = parseFloat(cpa12.toFixed(3))
    tbl13c.innerHTML = parseFloat(cpa13.toFixed(3))
    tbl14c.innerHTML = parseFloat(cpa14.toFixed(3))
    tbl15c.innerHTML = parseFloat(cpa15.toFixed(3))
    tbl16c.innerHTML = parseFloat(cpa16.toFixed(3))
}
